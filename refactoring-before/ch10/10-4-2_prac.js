class Rating {
  ...
  get value() {
    ...
    const historyRist = this.captainHistoryRisk;
    return profit * 3 > risk + historyRist * 2 ? "A" : "B";
  }
...
export const rating = (voyage, history) =>
  voyage.zone === "china" && history.some((v) => "china" === v.zone)
